          ...
          <tbody>
            {docs.map((doc) => (
              <tr key={doc.id} className="type-body-sm border-b border-hairline last:border-0">
                ...
                <td className="px-4 py-3 text-[var(--color-muted)]">{doc.category}</td>
                ...
                <td className="px-4 py-3 text-right">
                  <Link href={`/cms/policies/${doc.id}/edit`} className="type-caption font-semibold text-[var(--color-primary-blue)] hover:underline">
                    Edit
                  </Link>
                </td>
              </tr>
