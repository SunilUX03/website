...
export default async function AwardsListPage() {
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <h1 className="type-display-sm text-ink">Awards</h1>
        <Link href="/cms/awards/new" className="type-button btn-primary">
          + Add award
        </Link>
      </div>
            ...
            {docs.map((doc) => (
              <tr key={doc.id} className="type-body-sm border-b border-hairline last:border-0">
                ...
                <td className="px-4 py-3 text-right">
                  <Link href={`/cms/awards/${doc.id}/edit`} className="type-caption font-semibold text-[var(--color-primary-blue)] hover:underline">
                    Edit
                  </Link>
                </td>
              </tr>
