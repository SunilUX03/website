...
//
// "—" in an info cell means the prototype left that disclosure blank.
...
export const disclosures: DisclosureGroup[] = [
  ...
  },
  {
    ...
    rows: [
      { detail: "—", info: "Registered under societies Act." },
    ],
  },
  {
    sno: "6",
  ...
  },
  {
    ...
    rows: [
      { detail: "—", info: "The Chairman / Secretary convene(s) the Board Meeting from time to time, where the Chief Executive Officer, Tamil Nadu e-Governance Agency Other member of the Board of Directors shall be present." },
    ],
  },
  {
    sno: "9",
  ...
  },
  {
    ...
    rows: [
      { detail: "—", info: "As per Government norms." },
    ],
  },
  {
    sno: "11",
