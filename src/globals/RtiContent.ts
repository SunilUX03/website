  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "item", type: "textarea", required: true },
        { name: "rowsText", type: "textarea", required: true, admin: { description: 'One sub-row per line, formatted "Detail :: Info".' } },
      ],
    },
    {
      name: "howToFile",
      ...
      fields: [
        ...
        { name: "redirectNote", type: "text", required: true },
